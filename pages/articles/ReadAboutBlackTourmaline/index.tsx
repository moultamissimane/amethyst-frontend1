        ...
        <div className="container ml-32 grid w-full py-20 text-white md:grid-cols-2">
          ...
          <div className=" my-auto p-8">
            ...
            <div className=" text-lg">
              ...
              <br />
              Black Tourmaline is another crystal that's helpful for repelling
              those negative vibes. Reach for this stone if you're feeling like
              you need an extra hand when it comes to healing. This stone will
              help you to shift a negative mindset and is a great tool for
              meditation.
              <br />
            </div>
          </div>
