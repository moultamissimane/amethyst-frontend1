      ...
      <div className=" mt-24">
        ...
        <div className="container ml-32 grid w-full bg-black py-20 text-white md:grid-cols-2">
          ...
          <div className=" mx-5 max-h-96 flex-none overflow-hidden rounded-lg">
            <div className="">
              <img src="/images/quoteTourmaline.jpg" alt="forest" />
            </div>
          </div>
        </div>
        ...
        <div className="container ml-32 grid w-full py-20 text-white md:grid-cols-2">
          ...
          <div className=" my-auto p-8">
            ...
            <div className=" text-lg">
              ...
              to work with!
              <br />
              <span className="text-xl font-bold underline">CLEAR QUARTZ</span>
              <div className="ml-32 w-60 duration-500 ease-in-out hover:scale-90">
                <img src="/images/BlackQuartz.png" alt="Clear Quartz" />
              </div>
              <br />
              Clear quartz is, in my opinion, the best meditation stone. This is
              because it is a stone that has the power to awaken your crown
              chakra, which is associated with your psychic abilities.
              <br />
              Plus, despite being associated primarily with the crown chakra,
              clear quartz actually has the ability to balance all of your
              chakras. It is the ultimate balancing stone, and a great crystal
              to use to bring your other crystals back into alignment.
              <br />
              If you're feeling out of balance and like you could benefit from
              the properties of the “master healer”, clear quartz is the perfect
              stone for you to meditate with.
            </div>
          </div>
        </div>
        <Footer />
