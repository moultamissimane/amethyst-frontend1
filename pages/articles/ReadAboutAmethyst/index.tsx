      ...
      <div className=" mt-24">
        ...
        <div className="container ml-32 grid w-full bg-black py-20 text-white md:grid-cols-2">
          ...
          <div className=" mx-5 max-h-96 flex-none overflow-hidden rounded-lg">
            <div className="">
              <img src="/images/AmethystQuote.jpg" alt="forest" />
            </div>
          </div>
        </div>
        ...
        <div className="container ml-32 grid w-full py-20 text-white md:grid-cols-2">
          ...
          <div className=" my-auto p-8">
            ...
            <div className=" text-lg">
              ...
              to work with!
              <br />
              <span className="text-xl font-bold underline">Amethyst</span>
              <div className="ml-32 w-60 duration-500 ease-in-out hover:scale-90">
                <img src="/images/amethyst400.png" alt="Clear Quartz" />
              </div>
              <br />
              Amethyst is a form of quartz, which has a purple hue. This is a
              stone that is connected to the third eye chakra, which is
              associated with your intuition. For this reason, amethyst is one
              of the best crystals to enhance your meditation.
              <br />
              Using amethyst during meditation can promote inner peace and
              healing, relieve stress and enhance spiritual awareness.
              <br />
              If you want to connect more to your intuition, amethyst can be an
              amazing stone to work with before going to sleep. This is because
              it aids us in connecting to our subconscious mind during our sleep
              state!
            </div>
          </div>
        </div>
