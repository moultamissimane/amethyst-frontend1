...
const home: NextPage = () => {
  return (
    <div className="relative flex min-h-screen min-w-full items-center justify-center bg-black">
      <Header />
      <div className="container m-auto px-6 pt-32 md:px-12 lg:px-7 lg:pt-[4.8rem]">
        <div className="flex flex-wrap items-center px-2 md:px-0">
          <div className="relative -mt-60 lg:w-6/12 lg:py-24 xl:py-32 ">
            <Lottie />
          </div>
          <div className="-mt-96 w-full lg:-mb-56 lg:w-6/12">
        ...
        <section className="bg-[#202020] m-auto rounded-2xl flex justify-center w-full pt-20 pb-10 lg:pt-[120px] lg:pb-20">
